...
FossFuelCgeneral<-ggplot(data=FossFuel,aes(y=FossFuelConsumption,x=reorder(State,FossFuelConsumption)))+geom_col(aes(fill=State))+
  ...
  labs(
    title="All Cities FossFuel consumption distribution ifrom 2011 to 2014",
    x="State",
    y="Cunsumption"
  )+
...
FossFuelC2010<-FossFuel%>%
  ...
  labs(
    title="Top Five Cities for FossFuel Consumption in 2010",
    x="State",
    y="Cunsumption"
  )+
  theme(legend.position = 'none')+
...
FossFuelC2011<-FossFuel%>%
  ...
  ggplot(aes(x=reorder(State,FossFuelConsumption),y=FossFuelConsumption))+geom_col(aes(fill=State))+
  labs(
    title="Top Five Cities for FossFuel Consumption in 2011",
    x="State",
    y="Cunsumption"
  )+
  theme(legend.position = 'none')+
...
FossFuelC2012<-FossFuel%>%
  ...
  ggplot(aes(x=reorder(State,FossFuelConsumption),y=FossFuelConsumption))+geom_col(aes(fill=State))+
  labs(
    title="Top Five Cities for FossFuel Consumption in 2012",
    x="State",
    y="Cunsumption"
  )+
  theme(legend.position = 'none')+
...
FossFuelC2013<-FossFuel%>%
  ...
  ggplot(aes(x=reorder(State,FossFuelConsumption),y=FossFuelConsumption))+geom_col(aes(fill=State))+
  labs(
    title="Top Five Cities for FossFuel Consumption in 2013",
    x="State",
    y="Cunsumption"
  )+
  theme(legend.position = 'none')+
...
FossFuelC2014<-FossFuel%>%
  ...
  ggplot(aes(x=reorder(State,FossFuelConsumption),y=FossFuelConsumption))+geom_col(aes(fill=State))+
   labs(
    title="Top Five Cities for FossFuel Consumption in 2014",
    x="State",
    y="Cunsumption"
  )+
  theme(legend.position = 'none')+
