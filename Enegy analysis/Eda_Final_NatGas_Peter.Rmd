...
NatGasCgeneral<-ggplot(data=NatGas,aes(y=NatGasConsumption,x=reorder(State,NatGasConsumption)))+geom_col(aes(fill=State))+
  ...
  labs(
    title="All Cities NatGas consumption distribution ifrom 2011 to 2014",
    x="State",
    y="Cunsumption"
  )+
...
NatGasC2010<-NatGas%>%
  ...
  labs(
    title="Top Five Cities for NatGas Consumption in 2010",
    x="State",
    y="Cunsumption"
  )+
  theme(legend.position = 'none')+
...
NatGasC2011<-NatGas%>%
  ...
  ggplot(aes(x=reorder(State,NatGasConsumption),y=NatGasConsumption))+geom_col(aes(fill=State))+
  labs(
    title="Top Five Cities for NatGas Consumption in 2011",
    x="State",
    y="Cunsumption"
  )+
  theme(legend.position = 'none')+
...
NatGasC2012<-NatGas%>%
  ...
  ggplot(aes(x=reorder(State,NatGasConsumption),y=NatGasConsumption))+geom_col(aes(fill=State))+
  labs(
    title="Top Five Cities for NatGas Consumption in 2012",
    x="State",
    y="Cunsumption"
  )+
  theme(legend.position = 'none')+
...
NatGasC2013<-NatGas%>%
  ...
  ggplot(aes(x=reorder(State,NatGasConsumption),y=NatGasConsumption))+geom_col(aes(fill=State))+
  labs(
    title="Top Five Cities for NatGas Consumption in 2013",
    x="State",
    y="Cunsumption"
  )+
  theme(legend.position = 'none')+
...
NatGasC2014<-NatGas%>%
  ...
  ggplot(aes(x=reorder(State,NatGasConsumption),y=NatGasConsumption))+geom_col(aes(fill=State))+
   labs(
    title="Top Five Cities for NatGas Consumption in 2014",
    x="State",
    y="Cunsumption"
  )+
  theme(legend.position = 'none')+
