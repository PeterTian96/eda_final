...
```
    ...
    ## # A tibble: 255 × 8
    ##    StateCodes State   Region Division Coast `Great Lakes` Year  BiomassConsumpt…
    ##    <chr>      <chr>    <dbl>    <dbl> <dbl>         <dbl> <chr>            <dbl>
    ##  1 AL         Alabama      3        6     1             0 2010            169088
    ##  2 AL         Alabama      3        6     1             0 2011            179611
    ##  3 AL         Alabama      3        6     1             0 2012            181878
    ##  4 AL         Alabama      3        6     1             0 2013            194432
    ##  5 AL         Alabama      3        6     1             0 2014            186649
    ##  6 AK         Alaska       4        9     1             0 2010              4178
    ##  7 AK         Alaska       4        9     1             0 2011              4247
    ##  8 AK         Alaska       4        9     1             0 2012              4032
    ##  9 AK         Alaska       4        9     1             0 2013              5168
    ## 10 AK         Alaska       4        9     1             0 2014              5476
    ## # … with 245 more rows
...
```
    ...
    ##  9 AK         Alaska       4        9     1             0 2013              5168
    ## 10 AK         Alaska       4        9     1             0 2014              5476
    ## # … with 245 more rows, and 1 more variable: CumBiomassConsumption <dbl>
...
![](Eda_Final_Biosmass_Peter_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
![](Eda_Final_Biosmass_Peter_files/figure-gfm/unnamed-chunk-7-2.png)<!-- -->
...
![](Eda_Final_Biosmass_Peter_files/figure-gfm/unnamed-chunk-7-3.png)<!-- -->
...
![](Eda_Final_Biosmass_Peter_files/figure-gfm/unnamed-chunk-7-4.png)<!-- -->
...
![](Eda_Final_Biosmass_Peter_files/figure-gfm/unnamed-chunk-7-5.png)<!-- -->
...
![](Eda_Final_Biosmass_Peter_files/figure-gfm/unnamed-chunk-7-6.png)<!-- -->
...
![](Eda_Final_Biosmass_Peter_files/figure-gfm/unnamed-chunk-7-7.png)<!-- -->
...
![](Eda_Final_Biosmass_Peter_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
...
![](Eda_Final_Biosmass_Peter_files/figure-gfm/unnamed-chunk-8-2.png)<!-- -->
...
![](Eda_Final_Biosmass_Peter_files/figure-gfm/unnamed-chunk-8-3.png)<!-- -->
...
![](Eda_Final_Biosmass_Peter_files/figure-gfm/unnamed-chunk-8-4.png)<!-- -->
...
![](Eda_Final_Biosmass_Peter_files/figure-gfm/unnamed-chunk-8-5.png)<!-- -->
...
![](Eda_Final_Biosmass_Peter_files/figure-gfm/unnamed-chunk-8-6.png)<!-- -->
...
![](Eda_Final_Biosmass_Peter_files/figure-gfm/unnamed-chunk-8-7.png)<!-- -->
...
![](Eda_Final_Biosmass_Peter_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
